...
const url =
  "https://noaa-wcsd-pds-index.s3.us-east-1.amazonaws.com/pmtiles/Henry_B._Bigelow_HB1906_neo4j_with_geometry.parquet";
const all_columns = [
  // "geometry_hash",
  // "classification",
  // "point_count",
...
async function GetGeometries(rowStart, rowEnd) {
...
async function GetData() { // get start_end_times
  const data = await parquetReadObjects({
    file,
    compressors,
